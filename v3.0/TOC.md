...
+ How-to
  ...
  + Deploy
    ...
    + Orchestrated Deployment
      ...
      - [Overview of Ansible Operations](how-to/deploy/orchestrated/ansible-operations.md)
    ...
    - [TiSpark](how-to/deploy/tispark.md)
  ...
  + Upgrade
    ...
    - [Upgrade Data Migration](how-to/upgrade/data-migration.md)
  ...
  - Troubleshoot
    ...
    - [Troubleshoot Data Migration](how-to/troubleshoot/data-migration.md)
...
+ Reference
  ...
  + SQL
    ...
    + Data Types
      - [Numeric Types](reference/sql/data-types.md#numeric-types)
      - [Date and Time Types](reference/sql/data-types.md#date-and-time-types)
      - [String Types](reference/sql/data-types.md#string-types)
      - [JSON Types](reference/sql/data-types.md#json-types)
      - [The ENUM Data Type](reference/sql/data-types.md#the-enum-data-type)
      - [The SET Type](reference/sql/data-types.md#the-set-type)
      - [Data Type Default Values](reference/sql/data-types.md#data-type-default-values)
  ...
  + Tools
    ...
    + Data Migration
      ...
      + Features
        ...
        - [Synchronization Delay Monitoring](reference/tools/data-migration/features/overview.md#synchronization-delay-monitoring)
        + Sharding Support
      ...
      + Usage Scenarios
        - [Simple Scenario](reference/tools/data-migration/usage-scenarios/simple-synchronization.md)
  ...
  + Key Monitoring Metrics
    - [Overview](reference/key-monitoring-metrics/overview.md)
    - [TiDB](reference/key-monitoring-metrics/tidb.md)
    - [PD](reference/key-monitoring-metrics/pd.md)
    - [TiKV](reference/key-monitoring-metrics/tikv.md)
