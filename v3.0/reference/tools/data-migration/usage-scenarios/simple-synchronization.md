...
category: reference
aliases: ['/docs/v3.0/tools/dm/simple-synchronization-scenario/']
---
...
- To satisfy synchronization Requirements #1-i, #1-ii and #1-iii, configure the [table routing rules](reference/tools/data-migration/features/overview.md#table-routing) as follows:
...
- To satisfy the synchronization Requirement #2-i, configure the [table routing rules](reference/tools/data-migration/features/overview.md#table-routing) as follows:
...
- To satisfy the synchronization Requirement #1-iv, configure the [binlog filtering rules](reference/tools/data-migration/features/overview.md#binlog-event-filtering) as follows:
...
- To satisfy the synchronization Requirement #2-ii, configure the [binlog filtering rule](reference/tools/data-migration/features/overview.md#binlog-event-filtering) as follows:
...
- To satisfy the synchronization Requirement #3, configure the [black and white lists](reference/tools/data-migration/features/overview.md#black-and-white-table-lists) as follows:
...
The complete synchronization task configuration is shown below. For more details, see [configuration explanations](reference/tools/data-migration/configure/task-configuration-file.md).
