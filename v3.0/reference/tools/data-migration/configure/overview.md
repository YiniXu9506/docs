...
category: reference
aliases: ['/docs/v3.0/tools/dm/dm-configuration-file-overview/']
---
...
- `task.yaml.exmaple`: The standard configuration file of the data synchronization task (a specific task corresponds to a `task.yaml`). For the introduction of the configuration file, see [Task Configuration File](reference/tools/data-migration/configure/task-configuration-file.md).
